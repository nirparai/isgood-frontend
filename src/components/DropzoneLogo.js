...
<<<<<<< HEAD:src/components/Dropzone.js
export default function Dropzone({ formik, name, type }) {
=======
export default function DropzoneLogo({ formik, name, endpoint }) {
>>>>>>> cb5a2c57d99cdcff4f6070f9efe696af0f096de4:src/components/DropzoneLogo.js
