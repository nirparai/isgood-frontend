          ...
          <Row className="mt-4">
            <Col lg={3} sm={12}>
              <Nav variant="pills" className="sticky-top flex-column pt-2">
                <Nav.Item>
                  <Nav.Link eventKey="project-details" className="d-flex">
                    Project Details
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="impacts" className="d-flex">
                    Impacts
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="outcomes" className="d-flex">
                    Outcomes
                  </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey="beneficiary-groups" className="d-flex">
                    Beneficiary Groups
                  </Nav.Link>
                </Nav.Item>
              </Nav>
